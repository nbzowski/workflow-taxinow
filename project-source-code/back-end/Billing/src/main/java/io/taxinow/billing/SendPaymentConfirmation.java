package io.taxinow.billing;  // CHANGE to match your project
...
public class SendPaymentConfirmation {

    private static final Logger LOG = LogManager.getLogger(SendPaymentConfirmation.class);

    private static final String JOB_TYPE = "send-payment-confirmation";
