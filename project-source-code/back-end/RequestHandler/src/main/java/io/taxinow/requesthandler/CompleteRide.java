...
public class CompleteRide {
    ...
    private static final Logger LOG = LogManager.getLogger(CompleteRide.class);

    public static void main(String[] args) {
        try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
            client.newWorker().jobType("complete-ride").handler((jobClient, job) -> { // service-task-id must match the task type in Camunda!
