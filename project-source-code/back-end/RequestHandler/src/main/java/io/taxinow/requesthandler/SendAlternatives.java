...
public class SendAlternatives {

    private static final Logger LOG = LogManager.getLogger(SendAlternatives.class);

    private static final String JOB_TYPE = "send-alternatives";
