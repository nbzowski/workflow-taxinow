...
public class AcceptDeclineRide {

    private static final Logger LOG = LogManager.getLogger(AcceptDeclineRide.class);

    public static void main(String[] args) {
        try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
            client.newWorker().jobType("driver-accept-decline-ride").handler((jobClient, job) -> { // service-task-id must match the task type in Camunda!
                ...
                variablesMap.put("driverAccepted", "true");
