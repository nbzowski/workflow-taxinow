package io.taxinow;  // CHANGE to match your project
...
public class MessageThrowEventTemplate {

    private static final Logger LOG = LogManager.getLogger(MessageThrowEventTemplate.class);

    private static final String JOB_TYPE = "user-send-dest-addr";
