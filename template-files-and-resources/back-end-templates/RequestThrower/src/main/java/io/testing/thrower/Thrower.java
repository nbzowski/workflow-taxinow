...
public class Thrower {
    ...
    public static void main(String[] args) {
        ...
        try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
            ...
            client.newPublishMessageCommand().messageName("driver-msg-send-confirmation").correlationKey("1234").variables(Map.of("driverConfirmed", "true")).send().exceptionally(throwable -> { throw new RuntimeException("Could not publish message", throwable); });;
