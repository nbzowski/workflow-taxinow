...
public class ThrowerPayment {
    ...
    public static void main(String[] args) {
        ...
        try (ZeebeClient client = ZeebeClientFactory.getZeebeClient()) {
            ...
            client.newPublishMessageCommand().messageName("user-msg-send-payment-request").correlationKey("1234").variables(Map.of("driverConfirmed", "true")).send().exceptionally(throwable -> { throw new RuntimeException("Could not publish message", throwable); });;
